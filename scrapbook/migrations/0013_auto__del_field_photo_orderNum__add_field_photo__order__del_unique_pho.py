...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('scrapbook_photo', '_order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Entry.orderNum'
        db.delete_column('scrapbook_entry', 'orderNum')

        # Adding field 'Entry._order'
        db.add_column('scrapbook_entry', '_order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('scrapbook_photo', '_order')

        # Adding unique constraint on 'Photo', fields ['orderNum', 'entry']
        db.create_unique('scrapbook_photo', ['orderNum', 'entry_id'])

        # Adding field 'Entry.orderNum'
        db.add_column('scrapbook_entry', 'orderNum',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Entry._order'
        db.delete_column('scrapbook_entry', '_order')
