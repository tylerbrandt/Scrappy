...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Thumb', fields ['photo', 'size']
        db.delete_unique('scrapbook_thumb', ['photo_id', 'size'])
        ...
        db.alter_column('scrapbook_photo', 'image', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100))
    def backwards(self, orm):
        ...
        # Adding unique constraint on 'Thumb', fields ['photo', 'size']
        db.create_unique('scrapbook_thumb', ['photo_id', 'size'])
