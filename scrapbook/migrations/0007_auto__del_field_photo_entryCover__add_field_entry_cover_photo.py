...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Photo.entryCover'
        db.delete_column('scrapbook_photo', 'entryCover')

        # Adding field 'Entry.cover_photo'
        db.add_column('scrapbook_entry', 'cover_photo',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='coverphoto', null=True, to=orm['scrapbook.Photo']),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'Photo.entryCover'
        db.add_column('scrapbook_photo', 'entryCover',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Entry.cover_photo'
        db.delete_column('scrapbook_entry', 'cover_photo_id')
