...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('scrapbook_checkin', 'location',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Checkin.venueURL'
        db.add_column('scrapbook_checkin', 'venueURL',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Checkin.location'
        db.delete_column('scrapbook_checkin', 'location')

        # Deleting field 'Checkin.venueURL'
        db.delete_column('scrapbook_checkin', 'venueURL')
